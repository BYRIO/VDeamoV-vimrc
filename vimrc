"{vundle setup
  ...
  "{plugins
    ...
    "Plugin 'jaxbot/semantic-highlight.vim' "每个变量一个颜色
...
"{Plugin settings
  ...
  "now python cpp html json php is working
    ...
    let g:syntastic_javascript_checkers = ['eslint']
    let g:syntastic_javascript_jsxhint_exec = "/usr/local/bin/jshint"
...
"{auto commands
  ...
  autocmd BufNewFile,BufReadPost *.md set filetype=mkd "Maybe Conflict"
  ...
  autocmd BufRead,BufNewFile *.md set filetype=mkd "Maybe Conflict""
